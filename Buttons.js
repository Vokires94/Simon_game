...
class Buttons extends React.Component {
    ...
    handleClick(item) {
        ...
        if (tries === 5) {
            ...
            paint_buttons();
            shadow_buttons();shadow_buttons();
            lose!==true ? this.handleStartBlink() : document.getElementById ('go_play').disabled = false;
        }
   ...
   handleLevelChange() {
    ...
    handleStartBlink() {
       ...
       document.getElementById ('go_play').disabled = true;
        ...
        setTimeout(function() {
            clearInterval(timer)}, 15000-difficult*5);
        ...
        function Rand_blink() {
            ...
            for (var i = 0; i < 4; i++) {
                document.getElementsByClassName(arr[i])[0].style.background = arr2[i];
            }
